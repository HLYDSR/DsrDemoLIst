...
- (void)dragDidMoving:(DSRFloatButton *)button withEvent:(UIEvent *)ev
{
    isMoving = YES;
...
- (void)didTouched:(DSRFloatButton *)button withEvent:(UIEvent *)ev{
    if (!isMoving) {
