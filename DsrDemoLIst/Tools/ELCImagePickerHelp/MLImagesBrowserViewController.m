...
//  MartinDemos
//
//  Created by DengShiru on 14-12-21.
//  Copyright (c) 2014年 hlyclub. All rights reserved.
//

#import "MLImagesBrowserViewController.h"

@interface MLImagesBrowserViewController ()<DsrPageScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.pageView.dsrPageScrollViewDelegate = self;//（必填）
...
//    self.pageView.isAutoScroll = NO;//默认是NO（可选）
    ...
    self.pageView.pageViewType = DsrPageScrollViewFullScreenMode;//默认是广告模式（可选）
