...
@interface DSRScrollView () <UIScrollViewDelegate>

@property (nonatomic, copy) NSArray *imageArray;

@end

@implementation DSRScrollView
{
...
-(void)createPageControl
{
    ...
    //设置当前页面指示器的颜色
    pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.980 green:0.247 blue:0.290 alpha:1.000];
